        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-fade-in">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Ready to transform your business or join our mission? We'd love to hear from you. Let's start a
              ...
              <Card className="shadow-xl border-0 animate-slide-in-left">
                <CardContent className="p-8">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Button type="submit" size="lg" className="w-full bg-red-600 hover:bg-red-700 text-white group">
                      Send Message
            ...
            <div className="space-y-8 animate-slide-in-right">
              <Card className="shadow-lg border-0">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600 mb-4">Stay updated with our latest projects and opportunities.</p>
